                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" novalidate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="input" class="form-control {% if errors.name is defined %}is-invalid{% endif %}" id="name" name="name" value="{{ tmpTopping.name }}" tabindex="1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control {% if errors.status is defined %}is-invalid{% endif %}" id="status" name="status" tabindex="2">
                                                    <option value=""></option>
                                                    {% for statusOption in toppingStatuses %}
                                                        <option value="{{ statusOption }}" {% if (tmpTopping.status == statusOption) %} selected {% endif %}>
                                                            {{ translateToppingStatus(statusOption) }}
                                                        </option>
                                                    {% endfor %}
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="topping.php" class="btn btn-sm btn-outline-primary mt-2" tabindex="4">Annuleren</a>
                                            </div>
